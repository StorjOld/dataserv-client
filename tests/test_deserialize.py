...
class TestByteCount(unittest.TestCase):
    ...
    def test_base_1024(self):
        ...
        self.assertEqual(deserialize.byte_count("0.49K"), int(0.49 * (1024 ** 1)))
        ...
        self.assertEqual(deserialize.byte_count("0.49M"), int(0.49 * (1024 ** 2)))
        ...
        self.assertEqual(deserialize.byte_count("0.49G"), int(0.49 * (1024 ** 3)))
        ...
        self.assertEqual(deserialize.byte_count("0.49T"), int(0.49 * (1024 ** 4)))
        ...
        self.assertEqual(deserialize.byte_count("0.49P"), int(0.49 * (1024 ** 5)))
    ...
    def test_base_1000(self):
        ...
        self.assertEqual(deserialize.byte_count("0.5KB"), 0.5 * (1000 ** 1)))
        ...
        self.assertEqual(deserialize.byte_count("0.5MB"), 0.5 * (1000 ** 2)))
        ...
        self.assertEqual(deserialize.byte_count("0.5GB"), 0.5 * (1000 ** 3)))
        ...
        self.assertEqual(deserialize.byte_count("0.5TB"), 0.5 * (1000 ** 4)))
        ...
        self.assertEqual(deserialize.byte_count("0.5PB"), 0.5 * (1000 ** 5)))
